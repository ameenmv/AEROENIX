...
function main() {
  ...
  let totalUnused = 0
  for (const langKeys of Object.values(unusedKeys)) {
    totalUnused += langKeys.length
  }
  ...
  console.log(`🔍 Found ${totalUnused} unused keys to remove.\n`)
  ...
  for (const [language, keys] of Object.entries(unusedKeys)) {
