    ...
    <Variant title="Default">
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-8 p-8">
        <div class="light p-8 rounded-xl bg-background border border-border space-y-6">
          ...
          <div class="border border-border rounded-lg p-4 text-sm text-muted-foreground text-center">
            Table content here...
          </div>
          <DataTableToolbar :pagination="pagination" @paginate="goToPage" @update:page-size="changePageSize" />
        </div>
