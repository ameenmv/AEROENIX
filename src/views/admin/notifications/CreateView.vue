    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <div>
          ...
          />
          <p v-if="form.errors.value['content.en']" class="text-xs text-destructive mt-1">
            {{ form.errors.value['content.en'] }}
          </p>
        </div>
        <div>
      ...
      <div class="mt-4">
        ...
        <p v-if="form.errors.value.channels" class="text-xs text-destructive mt-1">
          {{ form.errors.value.channels }}
        </p>
      </div>
