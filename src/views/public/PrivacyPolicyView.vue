...
<style scoped>
/* Scoped styles to ensure typography looks perfect */
.prose h1, .prose h2, .prose h3 {
  color: var(--color-foreground, #0f172a);
}
.prose p, .prose ul, .prose li {
  color: var(--color-muted-foreground, #334155);
}
